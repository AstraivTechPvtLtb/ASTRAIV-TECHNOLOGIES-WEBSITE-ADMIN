...
async function main() {
  ...
  // 12. Create Client Reviews (Canonical Data Source)
  await prisma.review.createMany({
    data: [
      {
        clientName: 'Sarah Jenkins',
        company: 'FinanceFlow Capital',
        companyName: 'FinanceFlow Capital',
        ...
        reviewText: 'Astraiv provided the engineering rigor required for institutional financial compliance. Our auditors passed the security audit on the very first submission, and our monthly book close now takes hours instead of weeks.',
        originalReview: 'Astraiv provided the engineering rigor required for institutional financial compliance. Our auditors passed the security audit on the very first submission, and our monthly book close now takes hours instead of weeks.',
        rating: 5,
        displayRating: 5,
      ...
      },
      {
        ...
        reviewText: 'Astraiv Technologies transformed our core analytics platform. The speed improvement was noticed immediately by our franchise operators, and our monthly cloud bill dropped by 40% in the first quarter.',
        originalReview: 'Astraiv Technologies transformed our core analytics platform. The speed improvement was noticed immediately by our franchise operators, and our monthly cloud bill dropped by 40% in the first quarter.',
        rating: 5,
        displayRating: 5,
        projectId: 'pulsefit',
      ...
      },
      {
        ...
        companyName: 'AeroSync Logistics',
        ...
        reviewText: 'The route optimization algorithms delivered by Astraiv paid for the entire software investment in less than four months of operational fuel savings alone. Our drivers love the offline app.',
        originalReview: 'The route optimization algorithms delivered by Astraiv paid for the entire software investment in less than four months of operational fuel savings alone. Our drivers love the offline app.',
        rating: 5,
        displayRating: 5,
        projectId: 'aerosync',
      ...
      },
      {
        ...
        companyName: 'Lumina Energy Systems',
        ...
        reviewText: 'Astraiv provided Lumina with an institutional-grade brand identity that immediately unlocked enterprise utility contracts. Their token-driven workflow brought our design and engineering teams into perfect alignment.',
        originalReview: 'Astraiv provided Lumina with an institutional-grade brand identity that immediately unlocked enterprise utility contracts. Their token-driven workflow brought our design and engineering teams into perfect alignment.',
        rating: 5,
        displayRating: 5,
      ...
      },
      {
        ...
        companyName: 'Nova Global Brokerage',
        designation: 'Chief Technology Officer',
        ...
        reviewText: 'Astraiv Technologies rebuilt our entire broker core without a single minute of downtime. The speed and real-time collaboration have transformed how our trading desks close deals.',
        originalReview: 'Astraiv Technologies rebuilt our entire broker core without a single minute of downtime. The speed and real-time collaboration have transformed how our trading desks close deals.',
        rating: 5,
        displayRating: 5,
        projectId: 'nova-crm',
        serviceId: 'web-development',
      ...
      },
      {
        ...
        reviewText: 'Unrivaled expertise in modern web systems, Postgres optimization, and reactive UI architecture.',
        originalReview: 'Unrivaled expertise in modern web systems, Postgres optimization, and reactive UI architecture.',
        rating: 5,
        displayRating: 5,
